...
Lectures will be held in-person on {{< var keyInfo.lecture_time >}} in {{< var keyInfo.lecture_room >}}. 

- Recordings will be posted afterwards. Find them [here]({{< var keyInfo.recordings >}})
  - *Note*: Recording is provided as a courtesy and the quality of recorded lectures is not guaranteed.
