...
This course webpage/syllabus is a living document and may be updated as the semester progresses.
...
Lecture attendance/participation will be assessed using iClicker, [click here to learn more about iClicker]({{< var keyInfo.iclicker_info >}}).  These points are only available during lecture only during each lecture session.
...
Exams will make up the largest portion of your grade.  These will be written in-person.  The midterm will be Wednesday on March 13th.  The final exam will be completed during the examination period.
...
## Participation and Study Questions
