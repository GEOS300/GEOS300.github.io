...
$$
\small\frac{\delta \bar{u}}{\delta z} = \small\frac{u_*}{k}(z)^-b = \small\frac{u_*}{kz}
...
$$
\bar{u_z}=\small\frac{u_*}{k}ln(\small\frac{z}{z_0})
$${#eq-Log-Wind-Law}
...
* If observations are not available, a first order estimate of z0 can be obtained from a geometric analysis of the surface roughness elements.  A traditional rule-of-thumb gives: $z_0 = 0.1$
...
$$
\bar{u_z}=\small\frac{u_*}{k}ln(\small\frac{z-z_z}{z_0})
$${#eq-Log-Wind-Law}
