...
## Unit Conversion: Programmatic Examples {.smaller}

You can use [this tool](https://ubc.syzygy.ca/) to test both examples.
...
* In reality, wind is a vector consisting of three components:
  + x, y, & z represent fixed (e.g., cartesian coordinates in space)
  + Wind has u, v, & w components that are referenced to the either the cartesian coordinates, or mean flow, depending on the reference frame.
