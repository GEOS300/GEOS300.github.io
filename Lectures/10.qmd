...
ax[1].set_xlabel(r'$J m^{-2} K^{-1} K^{-1/2}$')
ax[1].grid(axis='x')
...
![Warren et al (2006)](images/10_17_2.jpg)
...
![Measuring transmission (Photo: Website U of Washington / Atmos Sci)](images/10_17_7.gif)
...
* Phase changes of water are accounted by a special term in the energy balance, $\Delta M$, which is the energy flux density put into (or released by) the latent heat of fusion of ice (Lf = 0.334 MJ kg<sup>-1</sup> at 0ºC)
...
* TS well below 0ºC.Only solid state of water.
* No water available for LE or $\Delta M$.
...
A better approach is to consider a volume balance and to treat all fluxes as equivalent flows through the sides of the volume. 
...
Similarly heat conduction within the snow will be very small because of the very low conductivity of snow and the lack of any solar heating, so ∆QS and QG are also negligible 
