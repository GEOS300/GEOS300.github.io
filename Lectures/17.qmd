...
$$
F_c = - \frac{\Delta\bar{\rho_v}}{r_{av}} 
...
$$
\tau = \rho \frac{\delta\bar{u}}{\delta z} 
$$
...
* Reynolds analogy assumes that the eddy diffusivities for different scalars are similar, i.e. KM = KH = KE = KC 
