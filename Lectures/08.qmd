...
* Why do we need to consider $H_{g_z}$ on a per-layer ($z$) basis?
...
Evaluating the above code give a value of: `r sprintf('%.3f W m<sup>-2</sup>',H_g_z)`  Does this appear correcnt?
